...
output_file = WEATHER_EDA_RESULTS_DIR / "02_low_duplicates.json"
...
def main(conn):
    ...
    report = {
        "warehouse_db_path": WAREHOUSE_DB_FILE.as_posix(),
        "raw_table": TABLE_WEATHER_RAW,
        "row_count": row_count,
    ...
    write_json_compact(
        ...
        parallel_array_groups=[("values", "counts", "percentages")],
    )
