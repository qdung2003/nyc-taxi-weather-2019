...
output_file = taxi_root / "eda" / "results" / "13_profile_upper_bounds.json"
...
def build_profiles(parquet: pq.ParquetFile):
    ...
    for rg in tqdm(
        ...
        desc="EDA 13 - pass 1 (profile columns)",
...
def build_payload(profiles):
    ...
    for field in schema:
        ...
        if col in month_counts:
            ...
            note = "12-month distribution from 05_apply_upper_bounds.parquet"
            ...
            note = "Zero and positive bins from 05_apply_upper_bounds.parquet (negative bins hidden; 10 raw bins)"
        else:
            ...
            note = "Value distribution from 05_apply_upper_bounds.parquet (count=0 values hidden)"
    ...
    return {
        "summary": {
            ...
            "clean_flow": "04_apply_business_rules_then_05_apply_upper_bounds",
        },
