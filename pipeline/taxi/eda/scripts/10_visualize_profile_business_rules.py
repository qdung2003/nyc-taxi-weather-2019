...
input_file = taxi_root / "eda" / "results" / "09_profile_business_rules.json"
output_file = taxi_root / "eda" / "results" / "10_profile_business_rules.html"
...
<head>
  ...
  <title>EDA 10 - Profile Business Rules</title>
  <style>
    :root {{
      --bg:#f6f8fc;
      --card:#ffffff;
...
<body>
  <div class=\"wrap\">
    <div class=\"card\">
      <h1>EDA 10 - Profile Business Rules</h1>
      <div class=\"kpis\">
